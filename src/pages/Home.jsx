  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", margin: "0.2rem 0 1.5rem 0" }}>
          {" "}
          {/* moved block further up */}
          <p
            style={{
              color: "#800000",
              fontWeight: "bold",
        ...
        >
          ...
          <p>
            We’d love to hear from you! Reach out with questions, opportunities,
            or just to connect.
          </p>
          ...
          <div style={{ marginTop: "1.5rem" }}>
            <strong>
              View Rwanda From Other Frames Narrating The Same Story:
            </strong>
            <div
              style={{
                display: "flex",
            ...
            >
              <a
                href="https://www.instagram.com/visitrwanda_now/"
                target="_blank"
              ...
              <span>|</span>
              <a
                href="https://www.instagram.com/thenewtimesrwanda/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#800000", textDecoration: "none" }}
              >
              ...
              <span>|</span>
              <a
                href="https://www.instagram.com/igiheofficial/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#800000", textDecoration: "none" }}
              >
              ...
              <span>|</span>
              <a
                href="https://www.instagram.com/rwanda__/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#800000", textDecoration: "none" }}
              >
        ...
        >
          <h2 style={{ color: "#800000", marginBottom: "1rem" }}>
            Suggestions
          </h2>
          <p style={{ marginBottom: "1.5rem" }}>
            Know a person, story, or event we should cover? Submit your thoughts
            and help us keep Rwanda seen and celebrated.
          </p>

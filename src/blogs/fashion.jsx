  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'Montserrat, sans-serif', lineHeight: '1.6' }}>
      ...
      <p style={{ marginBottom: '2rem' }}>
        Fashion in Rwanda’s celebrity world? No runway required.  
        This isn’t about red carpets or curated rules — it’s about <em>vibes</em>, confidence, and those moments when someone steps out and you just go… wow.
      </p>

      <p style={{ marginBottom: '2rem' }}>
        These aren’t picks based on fashion panels or voting systems.  
        It’s pure chaos. Pure love. Just outfits that made us stop scrolling.
      </p>
      ...
      <div style={rowWrapper}>
        ...
        <div style={middleParagraphStyle}>
          <p>
            So, here’s to the ones who dressed like the main character — whether they were headed to a café, a concert, or simply a moment of ✨ being ✨.
          </p>
          <p>
            🌛 <strong>Style Watch: No Rules, Just Radiance</strong><br />
            This feature isn’t a competition. It’s just a celebration of standout moments where our stars chose <em>style</em> —<br />
      ...
      {/* Sabine Mutabazi */}
      <p>
        🔥 <strong>Sabine Mutabazi’s Red + White Glow-Up</strong><br />
        On July 11<sup>th</sup>, during the <em>Kwibohora 31</em> celebration in Canada, Sabine made a jaw-dropping appearance in a bold red pant set, paired with a sleeveless white coat.
      </p>
...
<img src={process.env.PUBLIC_URL + "/images/sabine3.png"} alt="Sabine full-body outfit" style={imgStyleUniform} />
      ...
      {/* Tracy Umukunzi */}
      <p>
        💅 <strong>Tracy Umukunzi: Consistency is the Dress Code</strong><br />
        Whether it’s a brunch, or an IG soft launch, Tracy never misses. Her eye for structure, softness, and drama is unmatched.
      </p>
...
<img src={process.env.PUBLIC_URL + "/images/tracy3.png"} alt="Tracy's glam moment" style={imgStyleUniform} />
      ...
      {/* Element Eleéeh */}
      <p>
        🎤 <strong>Element: When the Producer Becomes the Poster</strong><br />
        At his Dallas concert this summer, Element wasn’t just serving sound — he served looks.
      </p>
...
<img src={process.env.PUBLIC_URL + "/images/ele3.png"} alt="Element’s fashion moment" style={imgStyleUniform} />
      ...
      {/* Jolly Mutesi */}
      <p>
        👑 <strong>Mutesi Jolly: A Walking Fashion Era</strong><br />
...
<img src={process.env.PUBLIC_URL + "/images/jolly3.png"} alt="Jolly being iconic" style={imgStyleUniform} />
      ...
      <p>
        She is — and might forever be — the definition of fashion royalty in Rwanda. Her looks walk, talk, and sometimes her style whispers, “Catch me if you can!”
      </p>

      <p>
        🧵 <strong>Final Frame</strong><br />
        These picks are random, unfiltered, and full of love for the bold, the beautiful, and the style-savvy.  
        If it made us gasp, pause, or screenshot — it made the cut.
      </p>
    </div>
  );
};

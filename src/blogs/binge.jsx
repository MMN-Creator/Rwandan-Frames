  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
        <img src={process.env.PUBLIC_URL + "/images/binge4.png"} alt="Darina welcoming guests at Binge Watch" style={imgStyleBalancedLeft} />
        <p style={{ flex: 1 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
        ...
        <img src={process.env.PUBLIC_URL + "/images/binge2.png"} alt="Katna’s Café movie setup" style={imgStyleBalancedRight} />
      </div>

      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
        <img src={process.env.PUBLIC_URL + "/images/binge3.png"} alt="Darina enjoying the movie night" style={imgStyleSmallLeft} />
        <p style={{ flex: 1 }}>
